...
void main() {
  runApp(MaterialApp(
    home: ArchitectModuleDesPage(),
  ));
}

class ArchitectModuleDesPage extends StatefulWidget {
  @override
  _ArchitectModuleDesPageState createState() => _ArchitectModuleDesPageState();
}

class _ArchitectModuleDesPageState extends State<ArchitectModuleDesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('IT Module Descriptor'),
