...
void main() {
  runApp(MaterialApp(
    home: ICEModuleDesPage(),
  ));
}

class ICEModuleDesPage extends StatefulWidget {
  @override
  _ICEModuleDesPageState createState() => _ICEModuleDesPageState();
}

class _ICEModuleDesPageState extends State<ICEModuleDesPage> {
