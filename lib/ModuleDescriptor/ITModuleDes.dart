...
void main() {
  runApp(MaterialApp(
    home: ITModuleDesPage(),
  ));
}

class ITModuleDesPage extends StatefulWidget {
  @override
  _ITModuleDesPageState createState() => _ITModuleDesPageState();
}

class _ITModuleDesPageState extends State<ITModuleDesPage> {
